...
fraction_pct.plot.contourf(
    ...
    levels=np.arange(0, 101, 5), extend='neither', cmap='YlOrRd',
    add_colorbar=True,
...
plt.tight_layout()
plt.savefig('figures/jjas_rainfall_fraction_elevation.png', dpi=200, bbox_inches='tight')
print('Saved figures/jjas_rainfall_fraction_elevation.png')
